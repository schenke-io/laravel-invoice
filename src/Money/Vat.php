 ...
 * @method static VatInterface ae()
 * @method static VatInterface au()
 * @method static VatInterface bh()
 * @method static VatInterface ca()
 * @method static VatInterface ch()
 * @method static VatInterface eg()
 * @method static VatInterface gb()
 * @method static VatInterface il()
 * @method static VatInterface ir()
 * @method static VatInterface iq()
 * @method static VatInterface jo()
 * @method static VatInterface jp()
 * @method static VatInterface kr()
 * @method static VatInterface kw()
 * @method static VatInterface lb()
 * @method static VatInterface om()
 * @method static VatInterface ps()
 * @method static VatInterface qa()
 * @method static VatInterface sa()
 * @method static VatInterface sy()
 * @method static VatInterface tr()
 * @method static VatInterface us()
 * @method static VatInterface ye()
 */
readonly class Vat
{
    public string $id;
